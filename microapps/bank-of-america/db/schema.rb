...
ActiveRecord::Schema.define(version: 20160912225249) do
  ...
  create_table "jounral_entries", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["account_id"], name: "index_jounral_entries_on_account_id", using: :btree
  end

  add_foreign_key "account_histories", "accounts"
  add_foreign_key "accounts", "customers"
  add_foreign_key "jounral_entries", "accounts"
end
